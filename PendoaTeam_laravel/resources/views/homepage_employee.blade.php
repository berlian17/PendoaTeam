            ...
            <div class="card" style="height: 450px" align="center">
                ...
                <div class="card-body">
                    @php
                        $item1 = 'Forklift';    
                    @endphp
                    <a class="btn btn-primary col-md" href="/employee/listItem/{{$item1}}" role="button">Forklift</a>
                </div>
            </div>
        </div>
        <div class="col-md-4" align="center">
            <div class="card" style="height: 450px" align="center">
                ...
                <div class="card-body">
                    @php
                        $item2 = 'Concrete pump';
                    @endphp
                    <a class="btn btn-primary col-md" href="/employee/listItem/{{$item2}}" role="button">Concrete Pump</a>
                </div>
            </div>
        </div>
        <div class="col-md-4" align="center">
            <div class="card" style="height: 450px" align="center">
                ...
                <div class="card-body">
                    @php
                        $item3 = 'Tower crane';
                    @endphp
                    <a class="btn btn-primary col-md" href="/employee/listItem/{{$item3}}" role="button">Tower Crane</a>
                </div>
            </div>
        </div>        
    </div>
        ...
        <div class="col-md-4" align="center">
            <div class="card" style="height: 450px" align="center">
                ...
                <div class="card-body">
                    ...
                    @endphp
                    <a class="btn btn-primary col-md" href="/employee/listItem/{{$item4}}" role="button">Generating Set</a>
                </div>
            </div>
        </div>
        <div class="col-md-4" align="center">
            <div class="card" style="height: 450px" align="center">
                ...
                <div class="card-body">
                    @php
                        $item5 = 'Boom lift';
                    @endphp
                    <a class="btn btn-primary col-md" href="/employee/listItem/{{$item5}}" role="button">Boom Lift</a>
                </div>
            </div>
        </div>
        <div class="col-md-4" align="center">
            <div class="card" style="height: 450px" align="center">
                ...
                <div class="card-body">
                    ...
                    @endphp
                    <a class="btn btn-primary col-md" href="/employee/listItem/{{$item6}}" role="button">Passenger Hoist</a>
                </div>
            </div>
        </div>           
    </div>
